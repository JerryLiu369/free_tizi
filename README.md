# 🦈 免费节点分享 | 每日自动更新 | Free Nodes

这里汇总了最新的免费 V2Ray 和 Clash 节点订阅地址。
脚本每 6 小时自动抓取一次，自动替换失效链接，确保大家随时都有免费梯子可以用。

支持客户端：
- Clash (包括 Clash Meta / Mihomo)
- V2Ray / Shadowrocket / Quantumult X 等支持通用订阅的软件
